...
@Component({
    selector: 'app-authority-change-password',
    standalone: true,
    imports: [
        CommonModule,
        ReactiveFormsModule,
...
export class AuthorityChangePasswordComponent {
    ...
    changePassword() {
        ...
        this.authService.changePassword({ oldPassword, newPassword }).subscribe({
            ...
            error: (err) => {
                const msg = err.error?.message || 'Failed to change password: ' + (err.message || 'Unknown error');
