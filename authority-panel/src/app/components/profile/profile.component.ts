      ...
      <div class="profile-wizard" *ngIf="profileForm">
        ...
        <ng-container *ngIf="!isEditing">
          <div class="view-header">
            ...
            <h2 class="view-name">{{ (user$ | async)?.name || 'Authority User' }}</h2>
          ...
          <div class="view-details">
            ...
            <div class="detail-row" *ngIf="(user$ | async)?.zone">
        ...
        <ng-container *ngIf="isEditing">
          ...
          <form [formGroup]="profileForm" (ngSubmit)="saveChanges()" class="profile-form">
            ...
            <div class="static-field-group" *ngIf="(user$ | async)?.zone">
              <div class="static-label">ASSIGNED JURISDICTION (ZONE)</div>
              <div class="static-content">
                <mat-icon>location_on</mat-icon>
                <span>{{ (user$ | async)?.zone }}</span>
              </div>
            </div>
