...
@Component({
      ...
      <div class="profile-wizard" *ngIf="profileForm">
        ...
        <ng-container *ngIf="!isEditing">
          <div class="view-header">
            ...
            <h2 class="view-name">{{ (user$ | async)?.name || 'Admin User' }}</h2>
  ...
  styles: [`
    ...
    .detail-row mat-icon { color: #3b82f6; font-size: 22px; }
    .detail-info label { font-size: 0.65rem; color: var(--text-muted); font-weight: 800; display: block; margin-bottom: 2px; }
    .detail-info p { margin: 0; font-weight: 600; color: var(--text-primary); }
    .edit-entry-btn { width: 100%; border-radius: 12px; height: 52px; font-weight: 700; font-size: 1rem; background-color: #3b82f6 !important; }
    ...
    .input-with-icon mat-icon { color: var(--text-muted); font-size: 20px; margin-right: 12px; }
    ...
    .static-label { font-size: 0.7rem; color: var(--text-muted); font-weight: 700; margin-bottom: 6px; }
    .static-content { display: flex; align-items: center; gap: 12px; color: var(--text-primary); font-weight: 500; font-size: 0.9rem; }
    .static-content mat-icon { font-size: 18px; color: #3b82f6; }
    ...
    body.dark-theme .avatar-large-view { border-color: #1e293b; }
    body.dark-theme .avatar-large { border-color: #1e293b; }
  `]
})
